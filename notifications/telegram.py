...
I18N = {
    "zh": {
        ...
        "buy_deferred_min_notional": "{symbol} 目标差额 ${diff}，但可投资现金 ${investable} 低于最小下单金额 ${min_notional}",
    ...
    "en": {
        ...
        "buy_deferred_min_notional": "{symbol} target gap ${diff}, but investable cash ${investable} is below the minimum order notional ${min_notional}",
