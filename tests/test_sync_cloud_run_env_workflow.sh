...
grep -Fq 'LONGBRIDGE_FEATURE_SNAPSHOT_FALLBACK_MODE=${LONGBRIDGE_FEATURE_SNAPSHOT_FALLBACK_MODE}' "$workflow_file"
grep -Fq 'remove_env_vars+=("LONGBRIDGE_FEATURE_SNAPSHOT_FALLBACK_MODE")' "$workflow_file"
grep -Fq 'LONGBRIDGE_FEATURE_SNAPSHOT_FALLBACK_CACHE_DIR=${LONGBRIDGE_FEATURE_SNAPSHOT_FALLBACK_CACHE_DIR}' "$workflow_file"
grep -Fq 'remove_env_vars+=("LONGBRIDGE_FEATURE_SNAPSHOT_FALLBACK_CACHE_DIR")' "$workflow_file"
grep -Fq 'LONGBRIDGE_FEATURE_SNAPSHOT_MAX_STALE_DAYS=${LONGBRIDGE_FEATURE_SNAPSHOT_MAX_STALE_DAYS}' "$workflow_file"
grep -Fq 'remove_env_vars+=("LONGBRIDGE_FEATURE_SNAPSHOT_MAX_STALE_DAYS")' "$workflow_file"
...
grep -Fq 'LONGBRIDGE_MARKET_SIGNAL_HANDOFF_INDEX_URI=${LONGBRIDGE_MARKET_SIGNAL_HANDOFF_INDEX_URI}' "$workflow_file"
grep -Fq 'remove_env_vars+=("LONGBRIDGE_MARKET_SIGNAL_HANDOFF_INDEX_URI")' "$workflow_file"
grep -Fq 'LONGBRIDGE_MARKET_SIGNAL_HANDOFF_MANIFEST_URI=${LONGBRIDGE_MARKET_SIGNAL_HANDOFF_MANIFEST_URI}' "$workflow_file"
grep -Fq 'remove_env_vars+=("LONGBRIDGE_MARKET_SIGNAL_HANDOFF_MANIFEST_URI")' "$workflow_file"
grep -Fq 'LONGBRIDGE_MARKET_SIGNAL_CONSUMPTION_AUDIT_URI=${LONGBRIDGE_MARKET_SIGNAL_CONSUMPTION_AUDIT_URI}' "$workflow_file"
grep -Fq 'remove_env_vars+=("LONGBRIDGE_MARKET_SIGNAL_CONSUMPTION_AUDIT_URI")' "$workflow_file"
grep -Fq 'LONGBRIDGE_MARKET_SIGNAL_CACHE_DIR=${LONGBRIDGE_MARKET_SIGNAL_CACHE_DIR}' "$workflow_file"
grep -Fq 'remove_env_vars+=("LONGBRIDGE_MARKET_SIGNAL_CACHE_DIR")' "$workflow_file"
grep -Fq 'LONGBRIDGE_MARKET_SIGNAL_REQUIRED=${LONGBRIDGE_MARKET_SIGNAL_REQUIRED}' "$workflow_file"
grep -Fq 'remove_env_vars+=("LONGBRIDGE_MARKET_SIGNAL_REQUIRED")' "$workflow_file"
grep -Fq 'LONGBRIDGE_MARKET_SIGNAL_FALLBACK_MODE=${LONGBRIDGE_MARKET_SIGNAL_FALLBACK_MODE}' "$workflow_file"
grep -Fq 'remove_env_vars+=("LONGBRIDGE_MARKET_SIGNAL_FALLBACK_MODE")' "$workflow_file"
grep -Fq 'LONGBRIDGE_MARKET_SIGNAL_MAX_STALE_DAYS=${LONGBRIDGE_MARKET_SIGNAL_MAX_STALE_DAYS}' "$workflow_file"
grep -Fq 'remove_env_vars+=("LONGBRIDGE_MARKET_SIGNAL_MAX_STALE_DAYS")' "$workflow_file"
