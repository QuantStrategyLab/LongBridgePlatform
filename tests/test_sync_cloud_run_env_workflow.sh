...
grep -Fq 'CRISIS_ALERT_SMTP_PASSWORD: ${{ secrets.CRISIS_ALERT_SMTP_PASSWORD }}' "$workflow_file"
...
grep -Fq 'CRISIS_ALERT_SMTP_PASSWORD_SECRET_NAME: ${{ vars.CRISIS_ALERT_SMTP_PASSWORD_SECRET_NAME }}' "$workflow_file"
grep -Fq 'CRISIS_ALERT_SMTP_STARTTLS: ${{ vars.CRISIS_ALERT_SMTP_STARTTLS }}' "$workflow_file"
grep -Fq 'CRISIS_ALERT_SMTP_SSL: ${{ vars.CRISIS_ALERT_SMTP_SSL }}' "$workflow_file"
...
grep -Fq 'secret_pairs+=("CRISIS_ALERT_SMTP_PASSWORD=${CRISIS_ALERT_SMTP_PASSWORD_SECRET_NAME}:latest")' "$workflow_file"
...
grep -Fq 'remove_env_vars+=("CRISIS_ALERT_SMTP_PASSWORD")' "$workflow_file"
grep -Fq 'remove_env_vars+=("CRISIS_ALERT_SMTP_STARTTLS")' "$workflow_file"
grep -Fq 'remove_env_vars+=("CRISIS_ALERT_SMTP_SSL")' "$workflow_file"
