...
CRISIS_ALERT_EMAIL_TO = RUNTIME_SETTINGS.crisis_alert_email_to
CRISIS_ALERT_EMAIL_FROM = RUNTIME_SETTINGS.crisis_alert_email_from
CRISIS_ALERT_SMTP_HOST = RUNTIME_SETTINGS.crisis_alert_smtp_host
CRISIS_ALERT_SMTP_PORT = RUNTIME_SETTINGS.crisis_alert_smtp_port
CRISIS_ALERT_SMTP_USERNAME = RUNTIME_SETTINGS.crisis_alert_smtp_username
CRISIS_ALERT_SMTP_PASSWORD = RUNTIME_SETTINGS.crisis_alert_smtp_password
CRISIS_ALERT_SMTP_STARTTLS = RUNTIME_SETTINGS.crisis_alert_smtp_starttls
CRISIS_ALERT_SMTP_SSL = RUNTIME_SETTINGS.crisis_alert_smtp_ssl
